/**
Listens for all the Cordova/Phonegap specific events (as of 1.6.0)
...
(function(){
	...
	if (!window.cordova || !window.PhoneGap) {
		enyo.error("Cordova/PhoneGap needs to be loaded before enyo for events to attach correctly");
	}
